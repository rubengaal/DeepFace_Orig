...
cfg.pretrained_modelpath = os.path.join(cfg.deca_dir, 'pretrain', 'deca_modelgit.tar')
...
cfg.model.param_list = ['shape', 'tex', 'exp', 'pose', 'cam', 'light'] #'focus_cam'
cfg.model.n_shape = 100
cfg.model.n_tex = 50
cfg.model.n_exp = 50
#cfg.model.n_focus_cam = 6
cfg.model.n_cam = 3
cfg.model.n_pose = 6
...
# ---------------------------------------------------------------------------- #
cfg.dataset = CN()
cfg.dataset.training_data = ['celeba']
