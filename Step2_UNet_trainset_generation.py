...
save_path = current_path+'/image_root/Data/'
if not os.path.exists(save_path):
    os.makedirs(save_path)

savefolder = current_path+'/image_root/Data/Dataset/'
...
testdata = datasets.TestData('image_root/Data/Dataset', iscrop=True, face_detector='fan',sample_step=10)
...
for img in tqdm(dir_list):
    ...
    cv2.imwrite('image_root/Data/Dataset/' + img.replace('.jpg','_visible_skin_mask.png'),img_mask*255)
